...
def payments(request):
    ...
    # Store the payment transaction inside Payments Model
    payment = Payment(
        user = request.user,
...
def place_order(request, total=0, quantity=0):
    ...
    # If the cart count is less than or equal to 0, redirect to the shop.
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date = d.strftime("%Y%m%d")  # Format date as YYYYMMDD
